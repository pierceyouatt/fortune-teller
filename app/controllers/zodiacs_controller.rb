class ZodiacsController < ApplicationController
  ...
  def maiden
    ...
    render("zodiacs/maiden.html.erb")
  end
  ...
  def scales
    ...
    render("zodiacs/scales.html.erb")
  end
  ...
  def scorpion
    ...
    render("zodiacs/scorpion.html.erb")
  end
  ...
  def archer
    ...
    render("zodiacs/archer.html.erb")
  end
  ...
  def waterbearer
    ...
    render("zodiacs/waterbearer.html.erb")
  end
